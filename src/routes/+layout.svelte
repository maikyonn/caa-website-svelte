...
<style>
	...
	* {
	...
	.logo {
		...
		pointer-events: none;
		user-select: none;
		filter: invert(27%) sepia(35%) saturate(603%) hue-rotate(174deg) brightness(91%) contrast(86%);
	}
	.logo-light {
		height: 100px;
		width: 100px;
		...
		pointer-events: none;
		user-select: none;
		filter: invert(53%) sepia(20%) saturate(798%) hue-rotate(330deg) brightness(93%) contrast(90%);
	}
</style>
